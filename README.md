...
一个基于 React 和 Node.js 开发的 Wallhaven 壁纸批量下载工具。提供了Web 交互界面、下载历史管理和生产环境部署支持。
...
- **下载管理**：
  ...
  - **上传本地图片**：支持将本地图片上传到服务器进行管理和预览（需认证）。
